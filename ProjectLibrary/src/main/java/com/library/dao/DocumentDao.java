...
public class DocumentDao implements DocumentsDaoInterface {
    ...
    public void deleteDocument(Document document) {
        ...
        try {
            ...
            PrintWriter writer = new PrintWriter("src/main/resources/Documents1.txt");
            ...
            File file2 = new File("src/main/resources/Documents1.txt");
            file1.delete();
    ...
    public void updateDocument(Document document) {
        ...
        try {
            ...
            while (file.hasNextLine()) {
                ...
                if (document.getId() == document1.getId()) {
                    document1 = gson.fromJson(line, Document.class);
                    writer.write(gson.toJson(updateDocumentFromJason(document1)));
                    writer.write("\n");
                }
            }
            file.close();
